    ...
    <div class="row">
        <div class="col-lg-4 col-sm-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" value="{{ $employees->nome ?? old('nome') }}" name="nome" class="form-control" id="nome"
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="cpf" value="{{ $employees->cpf ?? old('cpf') }}" class="form-control"
                    id="cpf" aria-describedby="cpfHelp" />
        ...
        <div class="col-lg-4 col-sm-6">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input data-datepicker="" value="{{ $employees->data_contratacao ?? old('data_contratacao') }}"
                        name="data_contratacao" aria-describedby="dateContrationHelp" class="form-control"
                        id="date_contration" type="text" placeholder="dd/mm/yyyy" required />
                </div>
